...
export default function ScienceWindow({
  ...
  const [wonderBonus, setWonderBonus] = useState(
    player.scienceCards.wonderBonus
  );
    ...
    <div id="scienceWindow">
      <div id="windowContent">
        ...
        <div>
          <ScienceInput
            cardNumber={tablet}
            setCardNumber={setTablet}
            cardName={"Tablette"}
          />
          <ScienceInput
            cardNumber={wheel}
            setCardNumber={setWheel}
            cardName={"Roue"}
          />
          <ScienceInput
            cardNumber={compass}
            setCardNumber={setCompass}
            cardName={"Compas"}
          />
        </div>
        ...
        <div className="boni">
          ...
          <input
            ...
            checked={wonderBonus}
            disabled={
              IsBabyloneBuilt && !player.scienceCards.wonderBonus ? true : false
            }
          ...
          <input
            ...
            checked={guildBonus}
            disabled={
              hasScienceGuild && !player.scienceCards.guildBonus ? true : false
            }
        ...
        <div className="buttons">
          ...
          <button
            onClick={() =>
              handleCalculClick(tablet, wheel, compass, wonderBonus, guildBonus)
            }
          >
            Confirm
          </button>
